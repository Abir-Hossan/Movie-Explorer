...
export default function SearchBar({ value, onChange, onClear }) {
  return (
    <div className="relative">
      ...
      />
      {value && <button onClick={onClear} aria-label="Clear search" className="absolute right-4 top-1/2 -translate-y-1/2 rounded-lg p-2 text-zinc-500 hover:text-white"><X size={18} /></button>}
    </div>
  );
}
